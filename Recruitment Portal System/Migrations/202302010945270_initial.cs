namespace Recruitment_Portal_System.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ApplicantID = c.String(nullable: false, maxLength: 128),
                        CVText = c.String(nullable: false),
                ...
                c => new
                    {
                        ...
                        JobStateBranchID = c.String(nullable: false, maxLength: 128),
                        JobType = c.String(nullable: false),
                        Description = c.String(nullable: false, maxLength: 500),
                        LookingFor = c.String(nullable: false),
                        Status = c.Boolean(nullable: false),
                        Salary = c.Decimal(nullable: false, precision: 18, scale: 2),
                        CreatedAt = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.StateBranches", t => t.JobStateBranchID, cascadeDelete: true)
                .ForeignKey("dbo.JobCategories", t => t.JobCategoryID, cascadeDelete: true)
                .Index(t => t.JobCategoryID)
                .Index(t => t.JobStateBranchID);
                ...
                c => new
                    {
                        ...
                        MeritScore = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ShortListedCandidates", "JobID", "dbo.Jobs");
            DropForeignKey("dbo.ShortListedCandidates", "ApplicantID", "dbo.ApplicantProfiles");
            DropForeignKey("dbo.Jobs", "JobCategoryID", "dbo.JobCategories");
            DropForeignKey("dbo.Jobs", "JobStateBranchID", "dbo.StateBranches");
            ...
            DropIndex("dbo.ShortListedCandidates", new[] { "ApplicantID" });
            DropIndex("dbo.ShortListedCandidates", new[] { "JobID" });
            DropIndex("dbo.Jobs", new[] { "JobStateBranchID" });
